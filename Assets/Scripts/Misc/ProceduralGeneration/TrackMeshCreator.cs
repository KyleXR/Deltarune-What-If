    ...
    public class TrackMeshCreator : PathSceneTool {
        ...
        { 
            ...
            for (int i = 0; i < path.NumPoints; i++)
            {
                ...
                // Rotate vertices by 90 degrees around the y-axis
                vertSideA = rotation * vertSideA;
                vertSideB = rotation * vertSideB;
                ...
                currentPosition += 50 * directionMultiplier;

                // Check if we need to reverse direction
                if (currentPosition >= 1000 || currentPosition <= -1000)
                {
                    directionMultiplier *= -1;
                    currentPosition += 100 * directionMultiplier; // Adjust to prevent immediate overlap after direction change
                }
            }
